...
class S3AsyncOutputStreamTest extends BaseTest {

    private final String key = S3AsyncOutputStreamTest.class.getSimpleName();
    private S3AsyncOutputStream instance;
    ...
    public void setUp() throws Exception {
        ...
        instance = new S3AsyncOutputStream(
